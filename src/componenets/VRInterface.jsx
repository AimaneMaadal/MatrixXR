...
function VRInterface() {
    ...
    return (
        <>
            <Text position={[-0.5, 3.25, -17.4]} fontSize={0.5} color="#000" anchorX="center" anchorY="middle"  font="/fonts/Yukita/YukitaSans-Bold.otf">
                VR FILTER
            </Text>
            ...
            <Button2 filterCategory="chair" position={[-3.5, 1.2, -17.48]} />
            <Button2 filterCategory="couch" position={[-2.6, 1.2, -17.48]} />
        </>
    )
}
